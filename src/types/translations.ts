...
export interface Translations {
  ...
  dashboard: {
    ...
    /**
     * Объяснение, где продвигать и продлевать объявление. Нужно потому, что в
     * приложении этого нет и не будет: платные тарифы требуют оплаты, а вести
     * из приложения на внешнюю оплату запрещает правило Apple 3.1.1.
     *
     * Текст объясняет действие целиком, а не отсылает одним адресом: человек
     * должен понять, что войти надо под той же учётной записью.
     */
    promoteHint: string
    /**
     * Подпись кнопки. Показывается ТОЛЬКО на Android: Google разрешает уводить
     * на внешнюю оплату для услуг реального мира, Apple — нет.
     */
    promoteOpen: string
  }
  form: {
